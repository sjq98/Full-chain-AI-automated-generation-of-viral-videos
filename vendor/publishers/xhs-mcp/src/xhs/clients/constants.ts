...
// Keep Chrome on its standard security and GPU paths even when a Playwright
// release would otherwise inject compatibility defaults.
export const PLAYWRIGHT_DEFAULT_ARGS_TO_IGNORE = [
  '--no-sandbox',
  '--disable-gpu',
